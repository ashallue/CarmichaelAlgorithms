...
There are four main components in this repository:
  - CN_query.cpp is a standalone program that answers "Is n a Carmichael number?"
  ...
  - A folder containing tabulation related programs.  
    - Two major drivers for our tabulation
    - Miscellany test files and one sample test case that should finish in a reasonable time
  - A folder containing our modification to Jon Sorenson's bit-packed incremental sieve (see [his paper](https://www.sciencedirect.com/science/article/abs/pii/S002001902400067X) and his [GitHub repo](https://github.com/sorenson64/soespace))
