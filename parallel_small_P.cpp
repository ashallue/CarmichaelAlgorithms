...
int main(int argc, char * argv[])
{
    ...
    std::string file_name = "nbd_node3_1433_1493_small_" + std::to_string(my_rank) + ".txt";
...
nbd node-1      990 < P < 1060      started 12:10pm 4-9: about 42 hours - except 1 process (!!! - run again)
