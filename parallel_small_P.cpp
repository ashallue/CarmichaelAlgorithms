...
int main(int argc, char * argv[])
{
    ...
    /*  the next 20:
     ...
     std::vector< uint64_t > AB =  {  2049180,  1923076,  1865671,  1811594,  1760563,  1712328,  1623376,  1582278,  1506024,  1470588,  1436781,  1404494,  1373626,  1315789, 1288659, 1237623, 1213592, 1168224, 1146788, 106194 };
